...
version_state_enum = ENUM(
    "draft",
    "pending_review",
    "approved",
    "rejected",
    "published",
    name="version_state_enum",
    create_type=False,
)
...
class Service(Base):
    ...
    current_published_version_id: Mapped[Optional[int]] = mapped_column(
        BigInteger,
        ForeignKey("service_versions.id", ondelete="SET NULL"),
    )

    pending_version_id: Mapped[Optional[int]] = mapped_column(
        BigInteger,
        ForeignKey("service_versions.id", ondelete="SET NULL"),
    )
    ...
    photography: Mapped[Optional["Photography"]] = relationship(
        "Photography",
        back_populates="service",
        uselist=False,
        cascade="all, delete-orphan",
    ...
    event_management: Mapped[Optional["EventManagement"]] = relationship(
        "EventManagement",
        back_populates="service",
        uselist=False,
        cascade="all, delete-orphan",
    ...
    makeup_artist: Mapped[Optional["MakeupArtist"]] = relationship(
        "MakeupArtist",
        back_populates="service",
        uselist=False,
        cascade="all, delete-orphan",
    ...
    __table_args__ = (
        ...
        Index("idx_services_location", "city", "state", "country"),
    )
