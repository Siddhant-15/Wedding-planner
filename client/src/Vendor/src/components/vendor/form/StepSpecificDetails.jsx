...
const StepSpecificDetails = ({ formData, updateField, errors = {} }) => {
  ...
  // Reusable field class for validation errors
      ...
      <div className={styles.step}>
        <div className={styles.grid2}>
          ...
          <div className={styles.field}>
            <FieldLabel required tooltip={t('min_capacity')}>
              Min capacity
            </FieldLabel>

            <input
              type="number"
              className={inputClass('min_capacity')}
            ...
            {renderError('min_capacity')}
          </div>

          {/* Max Capacity */}
          <div className={styles.field}>
            <FieldLabel required tooltip={t('max_capacity')}>
              Max capacity
            </FieldLabel>
          ...
          {/* Square Feet */}
          <div className={styles.field}>
            <FieldLabel required tooltip={t('square_feet')}>
              Square feet
            </FieldLabel>

            <input
              type="number"
              className={inputClass('square_feet')}
              value={formData.square_feet ?? ''}
              onChange={(e) =>
                updateField('square_feet', e.target.value)
              }
            />
          ...
          {/* Parking Capacity */}
          <div className={styles.field}>
            <FieldLabel tooltip={t('parking_capacity')}>
              Parking capacity
            </FieldLabel>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('parking_capacity', e.target.value)
              }
            />
          </div>
          ...
          {/* Venue Type */}
          <div className={styles.field}>
            <FieldLabel required tooltip={t('venue_type')}>
              Venue type
            </FieldLabel>

            <select
              className={selectClass('venue_type')}
            ...
            {renderError('venue_type')}
          </div>

          {/* Venue Nature */}
          <div className={styles.field}>
            <FieldLabel required tooltip={t('venue_nature')}>
              Indoor / Outdoor
            </FieldLabel>

            <select
              className={selectClass('venue_nature')}
              value={formData.venue_nature ?? ''}
              onChange={(e) =>
                updateField('venue_nature', e.target.value)
              }
            >
              <option value="">Select</option>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.grid3}>
            ...
            {/* Decoration Policy */}
            <div className={styles.field}>
              <FieldLabel tooltip={t('decoration_policy')}>
                Decoration
              </FieldLabel>
            ...
            {/* Catering Policy */}
            <div className={styles.field}>
              <FieldLabel tooltip={t('catering_policy')}>
                Catering
              </FieldLabel>
            ...
            {/* Alcohol Policy */}
            <div className={styles.field}>
              <FieldLabel tooltip={t('alcohol_policy')}>
                Alcohol
              </FieldLabel>
            ...
            >
              ...
              {(formData.venue_policies?.other_policies || []).map(
                (rule, index) => (
                  <div
                    key={index}
                    style={{
  ...
  if (formData.category === 'catering') {
    return (
      <div className={styles.grid2}>
        ...
        {/* Cuisine Types */}
        <div className={styles.field}>
          <FieldLabel required tooltip={t('cuisine_types')}>
            Cuisine Types
          </FieldLabel>
          ...
          {renderError('cuisine_types')}
        </div>

        {/* Special Diets */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('special_diets_supported')}>
          ...
          <TagInput
            ...
            onChange={(v) =>
              updateField('special_diets_supported', v)
            }
        ...
        {/* Service Styles */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('service_styles_multi')}>
            Service Styles
          </FieldLabel>
          ...
          <TagInput
            ...
            onChange={(v) =>
              updateField('service_styles_multi', v)
            }
        ...
        {/* Minimum Order */}
        <div className={styles.field}>
          <FieldLabel required tooltip={t('min_order')}>
            Minimum Order
          </FieldLabel>

          <input
            type="number"
            className={inputClass('min_order')}
          ...
          {renderError('min_order')}
        </div>

        {/* Maximum Order */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('max_order')}>
            Maximum Order
          </FieldLabel>
        ...
        >
          ...
          >
            <input
              ...
              onChange={(e) =>
                updateField('staff_included', e.target.checked)
              }
            />
            Staff Included
          </label>
          ...
          >
            <input
              ...
              onChange={(e) =>
                updateField('tasting_available', e.target.checked)
              }
            />
            Tasting Available
          </label>
  ...
  if (formData.category === 'dj') {
    return (
      <div className={styles.grid2}>
        ...
        {/* Genres */}
        <div className={styles.field}>
          <FieldLabel required tooltip={t('genres_supported')}>
            Genres Supported
          </FieldLabel>
          ...
          <TagInput
            ...
            onChange={(v) =>
              updateField('genres_supported', v)
            }
            placeholder="e.g., Bollywood, EDM, Punjabi"
          />

          {renderError('genres_supported')}
        </div>

        {/* Languages */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('languages_supported')}>
            Languages Supported
          </FieldLabel>
          ...
          <TagInput
            ...
            onChange={(v) =>
              updateField('languages_supported', v)
            }
        ...
        {/* Equipment */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('equipment')}>
            Equipment Provided
          </FieldLabel>
        ...
        <div className={styles.field}>
          <FieldLabel
            required
            tooltip={t('performance_duration_hours')}
          >
          ...
          {renderError('performance_duration_hours')}
        </div>

        {/* Setup Time */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('setup_time_minutes')}>
            Setup Time (minutes)
          </FieldLabel>
          ...
          <input
            ...
            onChange={(e) =>
              updateField('setup_time_minutes', e.target.value)
            }
          />
        </div>
  ...
  if (formData.category === 'photography') {
    return (
      <div className={styles.grid2}>
        ...
        {/* Photography Types */}
        <div className={styles.field}>
          <FieldLabel required tooltip={t('photography_types')}>
            Photography Types
          </FieldLabel>
          ...
          <TagInput
            ...
            onChange={(v) =>
              updateField('photography_types', v)
            }
            placeholder="e.g., Wedding, Pre-Wedding, Candid"
          />

          {renderError('photography_types')}
        </div>

        {/* Editing Styles */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('editing_styles')}>
            Editing Styles
          </FieldLabel>
        ...
        {/* Coverage Hours */}
        <div className={styles.field}>
          <FieldLabel required tooltip={t('coverage_hours')}>
            Coverage Hours
          </FieldLabel>

          <input
            type="number"
            className={inputClass('coverage_hours')}
            value={formData.coverage_hours ?? ''}
            onChange={(e) =>
              updateField('coverage_hours', e.target.value)
            }
          />

          {renderError('coverage_hours')}
        </div>

        {/* Overtime */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('overtime_rate_per_hour')}>
        ...
        {/* Team Size */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('team_size')}>
            Team Size
          </FieldLabel>
          ...
          <input
            ...
            onChange={(e) =>
              updateField('team_size', e.target.value)
            }
          />
        </div>

        {/* Photo Delivery Count */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('photo_delivery_count')}>
            Photos Delivered (Count)
          </FieldLabel>
        ...
        {formData.videography_available && (
          <div className={styles.field}>
            <FieldLabel tooltip={t('video_delivery_duration_minutes')}>
        ...
        {formData.album_included && (
          <div className={styles.field}>
            <FieldLabel tooltip={t('album_pages')}>
              Album Pages
            </FieldLabel>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('album_pages', e.target.value)
              }
            />
          </div>
        )}
        ...
        >
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.drone_shoot_available}
              onChange={(e) =>
                updateField(
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.edited_photos_included}
              onChange={(e) =>
                updateField(
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.raw_photos_provided}
              onChange={(e) =>
                updateField(
                  'raw_photos_provided',
                  e.target.checked
  ...
  if (formData.category === 'event_management') {
    return (
      <div className={styles.grid2}>
        ...
        {/* Event Types */}
        <div className={styles.field}>
          <FieldLabel required tooltip={t('event_types')}>
            Event Types
          </FieldLabel>
          ...
          <TagInput
            ...
            onChange={(v) =>
              updateField('event_types', v)
            }
            placeholder="e.g., Wedding, Corporate"
          />

          {renderError('event_types')}
        </div>

        {/* Themes */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('themes_supported')}>
            Themes Supported
          </FieldLabel>
          ...
          <TagInput
            ...
            onChange={(v) =>
              updateField('themes_supported', v)
            }
        ...
        {/* Services Offered */}
        <div className={styles.field}>
          <FieldLabel required tooltip={t('services_offered')}>
            Services Offered
          </FieldLabel>
          ...
          <TagInput
            ...
            onChange={(v) =>
              updateField('services_offered', v)
            }
            placeholder="e.g., Decor, Planning"
          />

          {renderError('services_offered')}
        </div>
        ...
        {/* Experience */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('experience_years')}>
            Experience (Years)
          </FieldLabel>
        ...
        >
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.decoration_included}
              onChange={(e) =>
                updateField(
                  'decoration_included',
                  e.target.checked
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.catering_management}
              onChange={(e) =>
                updateField(
                  'catering_management',
                  e.target.checked
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.entertainment_management}
              onChange={(e) =>
                updateField(
  ...
  if (formData.category === 'makeup_artist') {
    return (
      <div className={styles.grid2}>
        ...
        {/* Makeup Types */}
        <div className={styles.field}>
          <FieldLabel required tooltip={t('makeup_types')}>
            Makeup Types
          </FieldLabel>
          ...
          <TagInput
            ...
            onChange={(v) =>
              updateField('makeup_types', v)
            }
            placeholder="e.g., Bridal, Party"
          />

          {renderError('makeup_types')}
        </div>

        {/* Brands */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('brands_used')}>
            Brands Used
          </FieldLabel>
        ...
        {/* Specialization */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('specialization')}>
            Specialization
          </FieldLabel>
        ...
        {/* Service Duration */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('service_duration_minutes')}>
        ...
        {/* Travel Cost */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('travel_cost_per_km')}>
            Travel Cost per Km (₹)
          </FieldLabel>
        ...
        {/* Base City */}
        <div className={styles.field}>
          <FieldLabel tooltip={t('base_city')}>
            Base City
          </FieldLabel>
          ...
          <input
            ...
            onChange={(e) =>
              updateField('base_city', e.target.value)
            }
          />
        </div>
        ...
        >
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.premium_products_used}
              onChange={(e) =>
                updateField(
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.travel_to_client}
              onChange={(e) =>
                updateField(
                  'travel_to_client',
                  e.target.checked
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.hairstyling_included}
              onChange={(e) =>
                updateField(
          ...
          >
            <input
              type="checkbox"
              checked={!!formData.draping_included}
              onChange={(e) =>
                updateField(
                  'draping_included',
                  e.target.checked
